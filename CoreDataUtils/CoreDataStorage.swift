...
open class CoreDataStorage {
  ...
  lazy var managedObjectModel: NSManagedObjectModel = {
    ...
    let modelURL = Bundle.main.url(forResource: "Wome", withExtension: "momd")!
  ...
  lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
    ...
    let directory = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.wome")!
    let url = directory.appendingPathComponent("Wome.sqlite")
    do {
